...
public class IndexerQueue {
    ...
    public static void main(String[] args) throws K8sParameterNotFoundException {
        ...
        System.out.printf("Region: %s%n", environmentVariables.getRegion());
        System.out.printf("Queue Name: %s%n", environmentVariables.getQueueUrl());
        System.out.printf("Dead letter queue name: %s%n", environmentVariables.getDeadLetterQueueUrl());
        System.out.printf("Target url: %s%n", environmentVariables.getTargetURL());
        while (true) {
